...
struct PhotoList {
    ...
    Photo(imageName: "V1-1", title: "CROCHET EMBROIDERY ART", description: "A comprehensive foundation course with crochet embroidery, and you can invest in this course, exchange ideas and experiences, and start your own project",description2: "Four classes, as every Friday is a class" ,Eby: "By art_workshops3",place: ""),
